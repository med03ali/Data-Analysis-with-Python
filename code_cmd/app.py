...
# import more_itertools # This import was not used, can be removed
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            value='Yearly Statistics',  # CORRECTION: Set a valid default value
    ...
    html.Div(dcc.Dropdown(
            ...
            value=year_list[0]  # CORRECTION: Set a valid default value (e.g., the first year)

        )),

    html.Div([#TASK 2.3: Add a division for output display

    # CORRECTION: Replaced {flex} with {} to avoid NameError
...
@app.callback(
    ...
    # CORRECTION: Removed trailing space from 'value '
...
def update_output_container(selected_statistics, input_year):
    ...
    # Check for Yearly Statistics.              
        ...
        # This will be shown if the inputs are not valid (e.g., during initialization if no defaults were set)
...
if __name__ == '__main__':
    ...
    # CORRECTION: Use app.run_server() instead of app.run()
